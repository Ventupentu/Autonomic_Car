...
bool auria_msgs__msg__point_array__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("auria_msgs.msg._point_array.PointArray", full_classname_dest, 38) == 0);
  }
  auria_msgs__msg__PointArray * ros_message = _ros_message;
  {  // points
...
PyObject * auria_msgs__msg__point_array__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("auria_msgs.msg._point_array");
