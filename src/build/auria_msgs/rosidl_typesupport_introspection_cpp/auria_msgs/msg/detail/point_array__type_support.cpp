...
{
  new (message_memory) auria_msgs::msg::PointArray(_init);
}

void PointArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<auria_msgs::msg::PointArray *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PointArray_message_member_array[1] = {
  {
    ...
    offsetof(auria_msgs::msg::PointArray, points),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PointArray_message_members = {
  "auria_msgs::msg",  // message namespace
  "PointArray",  // message name
  1,  // number of fields
  sizeof(auria_msgs::msg::PointArray),
...
get_message_type_support_handle<auria_msgs::msg::PointArray>()
{
  return &::auria_msgs::msg::rosidl_typesupport_introspection_cpp::PointArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, auria_msgs, msg, PointArray)() {
  return &::auria_msgs::msg::rosidl_typesupport_introspection_cpp::PointArray_message_type_support_handle;
}
