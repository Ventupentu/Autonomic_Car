...
class Car(Node):
    def __init__(self):
        ...
        self.create_subscription(Bool, '/reset_car', self.reset_callback, 10)
    ...
    def reset_callback(self, msg):
        if msg.data:
            self.get_logger().info("♻️ Reset recibido. Reiniciando coche.")
            self.reset_state()
    ...
    def reset_state(self):
        ...
        self.acceleration = 0.0
        self.state = "running"
        self.get_logger().info("✅ Estado del coche reiniciado.")
