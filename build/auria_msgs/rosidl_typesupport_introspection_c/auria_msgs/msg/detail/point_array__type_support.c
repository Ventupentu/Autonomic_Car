...
#include <stddef.h>
#include "auria_msgs/msg/detail/point_array__rosidl_typesupport_introspection_c.h"
#include "auria_msgs/msg/rosidl_typesupport_introspection_c__visibility_control.h"
...
static rosidl_typesupport_introspection_c__MessageMember PointArray__rosidl_typesupport_introspection_c__PointArray_message_member_array[1] = {
  {
    ...
    offsetof(auria_msgs__msg__PointArray, points),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers PointArray__rosidl_typesupport_introspection_c__PointArray_message_members = {
  "auria_msgs__msg",  // message namespace
  "PointArray",  // message name
  1,  // number of fields
  sizeof(auria_msgs__msg__PointArray),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_auria_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, auria_msgs, msg, PointArray)() {
